...
//
// /*
// 1. pull testcases from into tmp/{taskId} (01.in, 01.out)
// 2. touch code.cpp inside tmp/{taskId}
// 3. compile code (send stream)
// 4. execute code on each testcases (send stream)
// 5. cleanup
// */
...
// 	// End
//
// 	// Create new code file and write content
...
// 	if !ok {
// 		return runner.ErrInvalidLanguage
// 	}
...
// 	defer cancel()
//
// 	ok, status := s.runner.Build(ctx, input.Language, codeFilename)
// 	if !ok {
...
//
// 		ok, result, err := s.runner.Run(ctx, input.Language, codeFilename, inputFilename)
// 		if err != nil {
// 			return err
// 		}
// 		if !ok {
...
// 		ok, err = s.checker.CheckFile(ctx, outputFilename, resultFilename)
// 		if err != nil {
// 			return err
// 		}
// 		if ok {
