...
var (
	...
	listTasks = []types.Task{
		...
		{
			Id:            2,
			DisplayName:   "Multiplication Madness",
			UrlName:       "multiplication_madness",
			TestcaseCount: 10,
			SolvedNumber:  1,
			Score:         100,
		},
		{
			Id:            3,
			DisplayName:   "Shortest Path in a Small Town",
			UrlName:       "shortest_path_in_a_small_town",
			TestcaseCount: 1,
			SolvedNumber:  0,
			Score:         0,
		},
		{
			Id:            4,
			DisplayName:   "Shortest Paths in a Large Town",
			UrlName:       "shortest_paths_in_a_large_town",
			TestcaseCount: 1,
			SolvedNumber:  0,
			Score:         0,
		},
